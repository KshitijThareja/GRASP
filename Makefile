CXX=			g++
CPPFLAGS=		-g -Wall -std=c++2a -march=native -O3 -w -I/home/kshitij/local/include
INCLUDES=
...
PROG=		PanAligner
LIBS=		-lz -lpthread -lm -fopenmp -L/home/kshitij/local/lib -lmetis -lGKlib
